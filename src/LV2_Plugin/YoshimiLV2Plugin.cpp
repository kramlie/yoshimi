...
#define YOSHIMI_LV2_POSITION_URI "http://lv2plug.in/ns/ext/time"
#define YOSHIMI_LV2_POSITION_beat YOSHIMI_LV2_POSITION_URI "#beat"
#define YOSHIMI_LV2_POSITION_bpm YOSHIMI_LV2_POSITION_URI "#beatsPerMinute"
    ...
    LV2_ATOM_SEQUENCE_FOREACH(_midiDataPort, event)
    {
        ...
        else if (event->body.type == _atom_blank || event->body.type == _atom_object)
        {
                ...
                && barBeat && barBeat->type == _atom_float)
            {
                ...
                // We will get the integer part from "beat", and the
                // fractional part from "barBeat".
